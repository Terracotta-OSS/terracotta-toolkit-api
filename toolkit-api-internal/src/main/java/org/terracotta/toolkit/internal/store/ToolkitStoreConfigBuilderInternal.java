...
public class ToolkitStoreConfigBuilderInternal extends ToolkitStoreConfigBuilder {
  ...
  public synchronized ToolkitStoreConfigBuilderInternal localStoreManagerName(String name) {
