 ...
 * creation of a {@code FinegrainedLock} instance a default lock type is also stored, which is corresponds to the default
 ...
 */
public interface FinegrainedLock extends TerracottaLock {
  /**
